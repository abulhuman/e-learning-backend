...
export interface IMutation {
  ...
  createChapter(
    createChapterInput?: Nullable<CreateChapterInput>,
  ): Chapter | Promise<Chapter>
  updateChapter(
    updateChapterInput?: Nullable<UpdateChapterInput>,
  ): Chapter | Promise<Chapter>
  removeChapter(id: string): Chapter | Promise<Chapter>
  createSubChapter(
    createSubChapterInput?: Nullable<CreateSubChapterInput>,
  ): SubChapter | Promise<SubChapter>
  updateSubChapter(
    updateSubChapterInput?: Nullable<UpdateSubChapterInput>,
  ): SubChapter | Promise<SubChapter>
  removeSubChapter(id: string): SubChapter | Promise<SubChapter>
  createCourseDocument(
    createCourseDocumentInput?: Nullable<CreateCourseDocumentInput>,
  ): CourseDocument | Promise<CourseDocument>
  updateCourseDocument(
    updateCourseDocumentInput?: Nullable<UpdateCourseDocumentInput>,
  ): CourseDocument | Promise<CourseDocument>
  ...
  ): StudentClass | Promise<StudentClass>
  updateStudentClass(
  ...
  removeDepartment(
    id: string,
  ): Nullable<Department> | Promise<Nullable<Department>>
